...
def load_data(timestep, data_num):
    ...
    for num in range(1, data_num+1):
        filename = train_path + f"widerange_{timestep}-{num:02d}_param_calc2.csv"
...
if __name__ == "__main__":
    ...
    fig_traj, fig_param = \
        plot_result(45000, 45500, y_true, y_traj_mb, y_traj_bb, y_traj_hyb, p_true, p_traj_hyb, u_true)
